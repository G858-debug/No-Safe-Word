        ...
        <section>
          ...
          <div className="mt-3 space-y-3">
            <p>
              ...
              Individual stories may be purchased for a one-time fee of R29.
              Once purchased, you have unlimited access to that story for as
              long as the Service is available. One-time purchases are not
              subscriptions and do not auto-renew.
            </p>
            <p>
              <strong className="text-warm-200">
                Inner Circle Subscription:
              </strong>{" "}
              The Inner Circle subscription provides unlimited access to all
              stories for R55 per month. Subscriptions are billed monthly via
              Payfast and auto-renew automatically until cancelled.
            </p>
            <p>
              ...
              access to Inner Circle content until that date. One-time story
              purchases (R29) are not subscriptions and do not require
              cancellation.
            </p>
            <p>
