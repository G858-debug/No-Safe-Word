...
export default function CharacterApproval({
  ...
  const handleGenerate = useCallback(
    ...
    [updateChar, startPolling, modelUrn, debugLevel]
  );
  ...
  const handleRegenerate = useCallback(
    ...
    [charStates, updateChar, startPolling, modelUrn, debugLevel]
  );
  ...
  const handleGenerateAll = useCallback(async () => {
    ...
    setGenerateAllProgress(null);
  }, [characters, charStates, updateChar, startPolling, modelUrn, debugLevel]);
