...
const COMFYUI_PROMPTS: DatasetPrompt[] = [
  // Waist-up (5-7) — body type visible but not full length
  {
    ...
    source: 'comfyui',
    category: 'waist-up',
    prompt: 'masterpiece, photorealistic, waist-up portrait, face and head fully visible, [ethnicity] woman, [bodyType], [skinTone] skin, [hairStyle] [hairColor] hair, wearing fitted tank top, natural standing pose, warm indoor lighting, clean background',
  ...
  },
  {
    ...
    source: 'comfyui',
    category: 'waist-up',
    prompt: 'masterpiece, photorealistic, waist-up portrait, face and head fully visible, [ethnicity] woman, [bodyType], [skinTone] skin, [hairStyle] [hairColor] hair, wearing wrap dress showing figure, 3/4 angle, golden hour side lighting, simple background',
  ...
  },
  {
    ...
    source: 'comfyui',
    category: 'waist-up',
    prompt: 'masterpiece, photorealistic, waist-up portrait, face and head fully visible, [ethnicity] woman, [bodyType], [skinTone] skin, [hairStyle] [hairColor] hair, wearing casual jeans and fitted t-shirt, relaxed pose, bright natural daylight, clean background',
  ...
  },
  {
    ...
    source: 'comfyui',
    category: 'waist-up',
    prompt: 'masterpiece, photorealistic, waist-up portrait, face and head fully visible, [ethnicity] woman, [bodyType], [skinTone] skin, [hairStyle] [hairColor] hair, wearing professional blouse, seated pose, soft office lighting, neutral background',
  ...
  },
  {
    ...
    source: 'comfyui',
    category: 'waist-up',
    prompt: 'masterpiece, photorealistic, waist-up shot, face and head fully visible, [ethnicity] woman, [bodyType], [skinTone] skin, [hairStyle] [hairColor] hair, wearing elegant evening dress, slight angle, dramatic warm lighting, dark background',
  ...
  // Full body (4-6) — head to feet
  {
    ...
    source: 'comfyui',
    category: 'full-body',
    prompt: 'masterpiece, photorealistic, full body standing pose, face and head fully visible, [ethnicity] woman, [bodyType], [skinTone] skin, [hairStyle] [hairColor] hair, wearing fitted jeans and crop top showing midriff, natural confident stance, studio lighting, clean white background, head to feet visible',
  ...
  },
  {
    ...
    source: 'comfyui',
    category: 'full-body',
    prompt: 'masterpiece, photorealistic, full body pose, face and head fully visible, head to feet, [ethnicity] woman, [bodyType], [skinTone] skin, [hairStyle] [hairColor] hair, wearing bodycon dress highlighting curves, walking pose, warm golden light, simple background, full length',
  ...
  },
  {
    ...
    source: 'comfyui',
    category: 'full-body',
    prompt: 'masterpiece, photorealistic, full body standing, face and head fully visible, head to feet, [ethnicity] woman, [bodyType], [skinTone] skin, [hairStyle] [hairColor] hair, wearing workout leggings and sports bra, athletic pose, bright gym lighting, clean background',
  ...
  },
  {
    ...
    source: 'comfyui',
    category: 'full-body',
    prompt: 'masterpiece, photorealistic, full body shot, face and head fully visible, head to feet, [ethnicity] woman, [bodyType], [skinTone] skin, [hairStyle] [hairColor] hair, wearing summer dress, casual standing pose outdoors, natural daylight, simple outdoor background',
  ...
  // Body detail / revealing (2-3, NSFW-capable checkpoint)
  {
    ...
    prompt: 'masterpiece, photorealistic, waist-up, face clearly visible, [ethnicity] woman, [bodyType], [skinTone] skin, [hairStyle] [hairColor] hair, wearing lace lingerie, confident sensual pose, warm bedroom lighting, soft background, intimate atmosphere',
  ...
  },
  {
    ...
    source: 'comfyui',
    category: 'body-detail',
    prompt: 'masterpiece, photorealistic, full body, face clearly visible, [ethnicity] woman, [bodyType], [skinTone] skin, [hairStyle] [hairColor] hair, wearing silk robe partially open, standing in doorway, dramatic side lighting, photorealistic',
