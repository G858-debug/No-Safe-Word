...
const MALE_BODY_PROMPTS: DatasetPrompt[] = [
  ...
  },
  {
    ...
    source: 'nano-banana',
    category: 'full-body',
    prompt: 'Full body photo, mid-stride walking with confident posture, wearing fitted tank top and athletic shorts, body shape visible through clothing, outdoor South African street background, golden hour light',
    description: 'Walking, tank top + shorts, outdoor SA',
  },
  {
    ...
    source: 'nano-banana',
    category: 'full-body',
    prompt: 'Full body photo, seated on chair leaning forward with elbows on knees, wearing fitted compression shirt and joggers, body shape visible through clothing, warm living room interior background',
    description: 'Seated, compression shirt, interior',
  },
  {
    ...
    source: 'nano-banana',
    category: 'full-body',
    prompt: 'Full body photo, standing with arms crossed, wearing sleeveless workout top and shorts, body shape visible through clothing, urban Johannesburg street background, natural daylight',
    description: 'Arms crossed, sleeveless top, urban JHB',
  },
  {
